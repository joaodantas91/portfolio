...
class LeftNavbar extends React.Component {
  ...
  render() {
    return (
      <Navbar
        beforeItem={this.state.isFirstLoad ? "" : this.state.beforeItem}
        currentItem={this.state.isFirstLoad ? "" : this.state.currentItem}
      >
        <StyledLink
          id="a1"
          to="/"
          ...
          onClick={() =>
            this.setState({ currentItem: "1", isFirstLoad: false })
          }
        >
          <Button>
            <HomeIcon />
        ...
        <StyledLink
          ...
          onClick={() =>
            this.setState({ currentItem: "2", isFirstLoad: false })
          }
        >
          <Button>
            <CodeIcon />
        ...
        <StyledLink
          ...
          onClick={() =>
            this.setState({ currentItem: "3", isFirstLoad: false })
          }
        >
          <Button>
            <WebIcon />
